...
@font-face {
  font-family: "pFangSans";
  src: url('~/assets/fonts/iosFont16.ttf') format('truetype');
}

$body-font-family: 'pFangSans', 'Roboto', sans-serif !default;
...
@each $key,
$border in $borders {
  $borders: map-deep-merge($borders,
    ($key: $border $border-style-root $border-color-root ))
}

$border-opacities: (
  ) !default;
$border-opacities: map-deep-merge((0: 0,
      null: .12,
      25: .25,
      50: .50,
      75: .75,
...
$states: map-deep-merge(('hover': 0.04,
      'focus': 0.12,
      'selected': 0.08,
      'activated': 0.12,
      'pressed': 0.16,
...
$grid-breakpoints: map-deep-merge(('xs': 0,
      'sm': 600px,
      'md': 960px,
      'lg': 1280px,
      'xl': 1920px,
...
$grid-gutters: map-deep-merge(('xs': math.div($grid-gutter, 12),
...
$container-max-widths: map-deep-merge(('xs': null,
      'sm': null,
...
$display-breakpoints: map-deep-merge(('print-only': 'only print',
...
$typography: map-deep-merge(('h1': ('size': 6rem,
        'weight': 300,
        'line-height': 6rem,
...
$values in $typography {
  $flat-typography: map-deep-merge($flat-typography,
