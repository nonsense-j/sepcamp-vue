        ...
        <v-timeline-item v-for="(task, i) in tasks" :key="i" :dot-color="typeColors[task.type]" size="small">
          ...
          <v-card elevation="6" width="60vw">
            ...
            <v-card-text class="py-0">
              <v-list class="py-0">
                <v-list-item v-for="question in task.questions" :key="question">
            ...
            <v-card-actions class="py-0">
              ...
              <v-spacer></v-spacer>
              <v-btn :color="submitColor[task.submitStatus]" variant="outlined" density="comfortable" class="text-btn">
